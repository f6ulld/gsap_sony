window.addEventListener("DOMContentLoaded", function () {
  //=== html document 요소가 모두 로드된후 실행될 코드 : gsap가 자체적으로 생성하는 요소를 제어하기 위한 코드
